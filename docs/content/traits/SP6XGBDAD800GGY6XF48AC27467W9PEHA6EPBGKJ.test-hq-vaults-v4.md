...
(define-constant min {
  activation-delay: u30,                                       ;; 30 seconds
})
...
(map-set protocol { address: .test-controller-hbtc-v4 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-vault-hbtc-v4 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-state-hbtc-v4 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-reserve-hbtc-v4-fund } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-zest-interface-hbtc-v4 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-hermetica-interface-hbtc-v4 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-bitflow-interface-hbtc-v4 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-granite-interface-hbtc-v4 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-fee-collector-hbtc-v4 } { active: true, ts: (some (get-current-ts)) })
...
(map-set keepers { address: .test-trading-hbtc-v4 } { trader: true, rewarder: false, manager: true, fee-setter: false })
