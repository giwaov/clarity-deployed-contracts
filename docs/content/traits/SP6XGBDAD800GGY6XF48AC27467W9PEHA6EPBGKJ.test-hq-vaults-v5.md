...
(map-set protocol { address: .test-controller-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-vault-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-state-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-reserve-fund-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-zest-interface-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-hermetica-interface-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-bitflow-interface-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-granite-interface-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
(map-set protocol { address: .test-fee-collector-hbtc-v5 } { active: true, ts: (some (get-current-ts)) })
...
(map-set keepers { address: .test-trading-hbtc-v5 } { trader: true, rewarder: false, manager: true, fee-setter: false })
