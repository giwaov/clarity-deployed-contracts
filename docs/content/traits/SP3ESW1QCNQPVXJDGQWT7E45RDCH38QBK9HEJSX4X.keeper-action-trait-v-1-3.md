---
title: "Trait keeper-action-trait-v-1-3"
draft: true
---
```
;; keeper-action-trait-v-1-3
...
(define-trait keeper-action-trait
  (
    (get-output (
      ...
      (optional (list 1000 <ft-trait>))
      (optional (list 1000 <xyk-pool-trait>))
      (optional (list 1000 <xyk-staking-trait>))
      (optional (list 1000 <xyk-emissions-trait>))
      (optional (list 1000 <stableswap-pool-trait>))
      (optional (list 1000 <stableswap-staking-trait>))
      (optional (list 1000 <stableswap-emissions-trait>))
      (optional (list 1000 <dlmm-pool-trait>))
      (optional (list 1000 <dlmm-staking-trait>))
      (optional (list 1000 uint))
      (optional (list 1000 bool))
      (optional (list 1000 principal))
    ) (response uint uint))
    (get-minimum (
      uint uint principal principal (buff 64) principal
      (optional (list 1000 <ft-trait>))
