---
title: "Trait stacks-strategy-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPBS7EFQDXF5886CBK24NDPW81B7RE8JD6HG7631.stacks-strategy-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u967773122784402)
    (var-set stx-balance u19980020)
