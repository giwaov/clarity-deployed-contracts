---
title: "Trait test-hermetica-interface-hbtc-v7"
draft: true
---
```
...
(define-public (hermetica-stake
  ...
  (let (
    ...
    (try! (contract-call? .test-state-hbtc-v7 check-trading-auth (contract-of staking) none none none))
    (try! (contract-call? .test-reserve-hbtc-v7 transfer usdh-token amount current-contract))
...
(define-public (hermetica-unstake
  ...
  (staking <staking-trait>))
  (let (
    (transfer-result (try! (contract-call? .test-reserve-hbtc-v7 transfer susdh-token amount current-contract)))
...
(define-public (hermetica-withdraw
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v7 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v7 check-trading-auth (contract-of staking-silo) none none none))
...
(define-public (hermetica-unstake-and-withdraw
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v7 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v7 check-trading-auth (contract-of staking) (some (contract-of staking-silo)) none none))
    (try! (contract-call? staking-silo withdraw claim-id))
...
(define-public (hermetica-mint
  ...
  (let (
    ...
    (minting-asset-data (contract-call? .test-state-hbtc-v7 get-asset minting-asset-contract))
    ...
    (try! (contract-call? .test-hq-vaults-v7 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v7 check-trading-auth (contract-of minting-auto) none (some minting-asset-contract) none))
    (try! (contract-call? .test-reserve-hbtc-v7 transfer minting-asset amount-asset current-contract))
    (try! (as-contract? 
...
(define-public (hermetica-redeem
  ...
  (let (
    ...
    (redeeming-asset-data (contract-call? .test-state-hbtc-v7 get-asset redeeming-asset-contract))
    ...
    (try! (contract-call? .test-hq-vaults-v7 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v7 check-trading-auth (contract-of minting-auto) none (some redeeming-asset-contract) none))    
    (try! (contract-call? .test-reserve-hbtc-v7 transfer usdh-token amount-usdh current-contract))
