---
title: "Trait test-granite-interface-hbtc-v4"
draft: true
---
```
...
(use-trait granite-borrower .test-granite-borrower-trait-v2.granite-borrower-trait)
...
(define-public (granite-borrow
  ...
  (begin
    ...
    (try! (contract-call? .test-state-hbtc-v4 check-trading-auth (contract-of borrower-trait) none (some (contract-of asset-trait)) none))
...
(define-public (granite-add-collateral
  ...
  (begin
    (try! (contract-call? .test-hq-vaults-v4 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v4 check-trading-auth (contract-of borrower-trait) none (some (contract-of collateral-trait)) none))
    (try! (contract-call? .test-reserve-hbtc-v4 transfer collateral-trait amount this-contract))
