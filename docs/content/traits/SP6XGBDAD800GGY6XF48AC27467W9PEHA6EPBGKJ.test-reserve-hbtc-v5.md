---
title: "Trait test-reserve-hbtc-v5"
draft: true
---
```
;; @contract Reserve
...
(define-public (transfer (asset <ft>) (amount uint) (recipient principal))
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v5 check-is-protocol-two contract-caller recipient))
    (try! (contract-call? .test-state-hbtc-v5 check-transfer-auth (contract-of asset)))
