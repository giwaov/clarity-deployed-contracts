---
title: "Trait stackspup-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1PWBNW9CK74G449NG6Q2TXAM4ST951XWCM69S5.stackspup-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u666888740172551)
