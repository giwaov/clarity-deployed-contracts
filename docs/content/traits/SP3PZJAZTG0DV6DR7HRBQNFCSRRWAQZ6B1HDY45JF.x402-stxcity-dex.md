...
(define-constant allow-token 'SP3PZJAZTG0DV6DR7HRBQNFCSRRWAQZ6B1HDY45JF.x402-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u65000000000000000)
    (var-set stx-balance u53846154)
