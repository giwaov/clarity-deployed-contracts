...
(use-trait spt 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-trait-v-1-2.stableswap-pool-trait)
...
(xt2 (optional (tuple (a <ft>) (b <ft>) (c <ft>) (d <ft>) (e <ft>) (f <ft>))))
(xp2 (optional (tuple (a <xpt>) (b <xpt>) (c <xpt>))))
)
(let (
(r1
(if (and
...
(m uint)
(p (optional principal))
(xt (tuple (a <ft>) (b <ft>) (c <ft>) (d <ft>) (e <ft>) (f <ft>)))
(xp (tuple (a <xpt>) (b <xpt>) (c <xpt>)))
)
(contract-call?
