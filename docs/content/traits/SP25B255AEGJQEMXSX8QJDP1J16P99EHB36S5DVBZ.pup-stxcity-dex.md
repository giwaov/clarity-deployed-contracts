...
(define-constant allow-token 'SP25B255AEGJQEMXSX8QJDP1J16P99EHB36S5DVBZ.pup-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u14700000000000000)
    (var-set stx-balance u42857143)
