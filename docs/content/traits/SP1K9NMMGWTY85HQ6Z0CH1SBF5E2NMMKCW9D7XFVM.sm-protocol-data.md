...
(define-read-only (get-all-vault-ratios)
  (ok {
    ...
    usdh: {
      vault-id: USDH,
      shares-to-assets: (unwrap-panic (contract-call? .sm-vault-usdh convert-to-assets u1000000)),
      underlying: UNDERLYING-USDH
    },
    ststxbtc: {
      vault-id: stSTXbtc,
      shares-to-assets: (unwrap-panic (contract-call? .sm-vault-ststxbtc convert-to-assets u100000000)),
