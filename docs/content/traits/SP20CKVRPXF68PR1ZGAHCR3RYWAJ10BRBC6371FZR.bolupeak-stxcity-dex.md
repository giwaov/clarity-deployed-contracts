---
title: "Trait bolupeak-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP20CKVRPXF68PR1ZGAHCR3RYWAJ10BRBC6371FZR.bolupeak-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u15329249617151608)
    (var-set stx-balance u36993007)
