---
title: "Trait coldstore-bonus-faktory"
draft: true
---
```
      ...
      (define-constant DEX-DAO 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.coldstore-faktory-dex)
      (define-constant TOKEN-DAO 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.coldstore-faktory)
      ...
      (define-public (deposit-bonus (new-agent-amount uint) (new-originator-amount uint))
        (begin
          ...
          (try! (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fakfun-core-v2 log-bonus-deposit new-agent-amount new-originator-amount))
          (ok true)
        )
      )
      ...
      (define-public (claim-agent-bonus (ft <faktory-token>))
        (let ((amount (var-get agent-amount)))
          ...
          (try! (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fakfun-core-v2 log-bonus-claim-agent FAKTORY amount))
          (ok true)
        )
      )
      ...
      (define-public (claim-originator-bonus (ft <faktory-token>))
        (let ((amount (var-get originator-amount)))
          ...
          (try! (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.fakfun-core-v2 log-bonus-claim-originator ORIGINATOR amount))
          (ok true)
        )
      )
