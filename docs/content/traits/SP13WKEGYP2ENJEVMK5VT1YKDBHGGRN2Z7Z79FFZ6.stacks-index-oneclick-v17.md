---
title: "Trait stacks-index-oneclick-v17"
draft: true
---
```
;; =====================================================================
;; StacksIndex OneClick V17 - 2 Token Support (STX + sBTC)
;; =====================================================================
;;
;; V17: Simplified contract for 2 tokens only (STX and sBTC)
...
(define-constant BITFLOW-ROUTER-V17 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.router-stableswap-xyk-v-1-5)
...
(define-private (execute-swap-2hop
  ...
  (contract-call? BITFLOW-ROUTER-V17 swap-helper-a
    amount
    min-out
    none       ;; provider
...
;; Note: router expects xyk-pool-trait-v-1-2 for both pools
