...
(define-private (reset-state-for-cycle (yield-cycle-id-wanted uint))
  (let (
      (yield-data (contract-call?
        'SP1HFCRKEJ8BYW4D0E3FAWHFDX8A25PPAA83HWWZ9.dual-stacking-v1
        get-yield-cycle-data yield-cycle-id-wanted
      ))
      ...
      (begin
        ...
        (if (> reward-amount u0)
          (try! (as-contract?
            ((with-ft
              'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token
              "sbtc-token" reward-amount
            ))
            (unwrap-panic (contract-call?
              'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token
              transfer reward-amount tx-sender user none
            ))
          ))
          false
        )
  ...
  (let ((sbtc-amount (unwrap!
    ...
    (try! (as-contract?
      ((with-ft 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token
        "sbtc-token" sbtc-amount
      ))
      (unwrap-panic (contract-call?
        'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token
        transfer sbtc-amount tx-sender (var-get admin) none
      ))
    ))
    (ok true)
  )
...
(define-read-only (state-last-operation)
  (if (and
      ...
      (is-some (contract-call?
        'SP1HFCRKEJ8BYW4D0E3FAWHFDX8A25PPAA83HWWZ9.dual-stacking-v1
        get-yield-cycle-data (+ (var-get last-cycle-id) u1)
      ))
      (is-eq (var-get current-cycle-participants-count)
        (var-get rewarded-count)
      )
