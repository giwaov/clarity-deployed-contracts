---
title: "Trait advanced-market-trait"
draft: true
---
```
...
(define-trait market-trait
    (
        ...
        (list-in-ft (uint uint <commission-trait> <sip-010-trait>) (response bool uint))
        (buy-in-ft (uint <commission-trait> <sip-010-trait>) (response bool uint))
    )
)
