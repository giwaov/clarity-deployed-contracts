  ...
  (let (
    ...
    (if ststx-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1K9NMMGWTY85HQ6Z0CH1SBF5E2NMMKCW9D7XFVM.sm-vault-ststx
            deposit
            token-balance
            u0
            account
    ...
    (if wstx-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1K9NMMGWTY85HQ6Z0CH1SBF5E2NMMKCW9D7XFVM.sm-vault-stx
            deposit
            token-balance
            u0
            account
    ...
    (if usdh-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1K9NMMGWTY85HQ6Z0CH1SBF5E2NMMKCW9D7XFVM.sm-vault-usdh
            deposit
            token-balance
            u0
            account
    ...
    (if sbtc-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1K9NMMGWTY85HQ6Z0CH1SBF5E2NMMKCW9D7XFVM.sm-vault-sbtc
            deposit
            token-balance
            u0
            account
    ...
    (if ststxbtc-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1K9NMMGWTY85HQ6Z0CH1SBF5E2NMMKCW9D7XFVM.sm-vault-ststxbtc
            deposit
            token-balance
            u0
            account
