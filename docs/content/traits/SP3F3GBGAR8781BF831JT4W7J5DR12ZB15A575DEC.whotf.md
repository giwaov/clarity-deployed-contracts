...
(define-public (isthis
    ...
    (xp1 (optional (tuple (a <xp-trait>) (b <xp-trait>) (c <xp-trait>))))
    (a5 (optional uint))
    (a6 (optional uint))
    ...
    (vt2 (optional (tuple (a <vft-trait>) (b <vft-trait>) (c <vft-trait>) (d <vft-trait>))))
...
(define-private (call-b
    ...
    (sp (tuple (a <sp-trait>)))
    (vt (tuple (a <vft-trait>) (b <vft-trait>) (c <vft-trait>) (d <vft-trait>)))
    (vs <vsft-trait>)
  )
  (contract-call?
