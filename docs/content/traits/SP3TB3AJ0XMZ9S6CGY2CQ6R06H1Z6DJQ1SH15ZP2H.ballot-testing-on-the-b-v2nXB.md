---
title: "Trait ballot-testing-on-the-b-v2nXB"
draft: true
---
```
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-stx-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u4706413))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Testing%20on%20the%20blockchain")
    (var-set description u"%3Cp%3EProviding%20context%20for%20the%20poll%3C%2Fp%3E")
    (var-set voting-system "weighted")
    (var-set options (list "ea9cc8b3-fac4-449c-b306-3dec1908ba8a" "658e982f-9339-4e59-b67f-265358a25149"))
    (var-set start u923136)
    (var-set end u999999)
    (map-set results {id: "ea9cc8b3-fac4-449c-b306-3dec1908ba8a"} {count: u0, name: u"Choice%201", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "658e982f-9339-4e59-b67f-265358a25149"} {count: u0, name: u"Choice%202", locked-stx: u0, unlocked-stx: u0})
```
