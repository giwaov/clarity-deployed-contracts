---
title: "Trait test-fee-collector-hbtc-v5"
draft: true
---
```
...
(define-public (withdraw (asset <ft>))
  (let (
    ...
    (fee-address (contract-call? .test-state-hbtc-v5 get-fee-address))
  )
    (try! (contract-call? .test-state-hbtc-v5 check-is-transfer-active))
    (try! (contract-call? .test-state-hbtc-v5 check-is-asset asset-contract))
