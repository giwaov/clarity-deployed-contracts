---
title: "Trait stacks-index-oneclick-v19"
draft: true
---
```
;; =====================================================================
;; StacksIndex OneClick V19 - 2 Token Support (STX + sBTC)
;; =====================================================================
;;
;; V19: Uses correct Bitflow contracts based on SDK analysis
...
;; Bitflow pool traits
;; Use v-1-4 trait for both legs (pool v-1-1 implements this trait)
...
;; Bitflow Contracts
;; Stableswap core for USDCx -> aeUSDC (v-1-4 uses v-1-4 trait)
(define-constant STABLESWAP-CORE 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-core-v-1-4)
...
;; Uses stableswap-core-v-1-2 swap-x-for-y (requires v-1-4 trait)
...
(define-public (invest-diversified
    ...
    ;; Step 1: USDCx -> aeUSDC (stableswap-core, v-1-4 trait)
    ;; Step 2: aeUSDC -> STX (xyk-swap-helper)
    (stx-amount uint)
    (stx-min-out uint)
    ;; Stableswap params (v-1-4 trait for stableswap-core)
