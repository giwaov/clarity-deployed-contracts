---
title: "Trait test-token-hbtc-v6"
draft: true
---
```
...
(define-data-var token-name (string-ascii 32) "Staging Hermetica hBTC v6")
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    ...
    (if (var-get blacklist-enabled)
      (try! (contract-call? .test-blacklist-vaults-v6 check-is-not-full-two sender recipient))
      true
    )
