...
(define-public (mint)
  (begin
    ...
    (ft-mint? tSTX (var-get user-mint-amount) tx-sender)
  )
)
...
(ft-mint? tSTX DEPLOY_MINT_AMOUNT CONTRACT_DEPLOYER)
```
