---
title: "Trait cf-vault-hztest-vaultzz-v1-786772"
draft: true
---
```
...
(define-constant CLIENT 0x1c389a1e71ace8660a8ea16013e6a14d22cb099a7639145d831f2fc37541fec0)
(use-trait wrapper-trait 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-traits-v0.wrapper-trait)
...
(define-private (calculate-fee (amount uint))
    (let (
            (fee-bps (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0 get-client-fee-bps CLIENT))
...
(define-private (assert-valid-caller)
    (let ((user (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0 get-user-id-by-address tx-sender)))
        (asserts!
            (or
                (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0 is-cofund-admin tx-sender)
...
(define-public (execute-transaction
    ...
    (begin
        ...
        (let (
                ...
                (policy (unwrap!
                    (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0 get-policy CLIENT
                        policy-id
                    )
                    ERR_INVALID_POLICY
                ))
    ...
    (begin
        ...
        (let (
            ...
            (let (
                    ...
                    (fee-recipient (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0
...
(define-private (verify-transaction-signature
    ...
    (begin
        ...
        (asserts!
            (is-none (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0 get-used-auth-ids CLIENT auth-id))
            ERR_AUTH_ID_REPLAY
        )
        ...
        ;; update auth-id
        (unwrap!
            (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0 set-auth-id CLIENT "vault"
                auth-id
            )
            ERR_AUTH_ID_REPLAY
        )
...
(define-private (verify-transaction-signature-helper
    ...
    (match signed-response
        ok-response (let (
                ...
                (user-id (get user-id
                    (unwrap!
                        (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0
                            get-user-id-by-address signer-address
                        )
                        ERR_INVALID_USER
                    )))
                (user (unwrap!
                    (contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0 get-user CLIENT user-id)
                    ERR_INVALID_USER
                ))
            )
...
(contract-call? 'SPDD5E92SY1F9C6MSGFZF8JNWWXBAEKBG26WFVGR.cf-helpers-state-v0 new-client CLIENT 0x21cb9e2f3d53727a9f1ec63585f758fb1ac26b3fcf43206e1a72424442c6646e "3fe1f7ff-e79a-478a-9ea3-b6ccb0e90f6f" "BUSINESS")
