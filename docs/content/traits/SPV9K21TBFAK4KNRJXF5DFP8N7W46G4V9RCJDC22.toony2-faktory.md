---
title: "Trait toony2-faktory"
draft: true
---
```

;; 
;; toony2 Powered By Faktory.fun v1.0 
...
(define-fungible-token TOONY2 MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? TOONY2 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance TOONY2 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? TOONY2 (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-faktory-dex))
    (try! (ft-mint? TOONY2 (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-pre-faktory))
