---
title: "Trait keeper-4-oaqt1c4s1-v-1-1"
draft: true
---
```
;; keeper-4-oaqt1c4s1-v-1-1
...
(define-data-var owner-address principal 'SP2R0FTKKA86ABYJ663SEFNMEMBQGXEFRKFGXHENG)

;; Bitcoin address authorized to receive bridged rune tokens and bitcoin
(define-data-var bitcoin-address (buff 64) 0x62633171763066716677797861356e736c70667963716d6a753564343437356c6d78336d64786133336e)
