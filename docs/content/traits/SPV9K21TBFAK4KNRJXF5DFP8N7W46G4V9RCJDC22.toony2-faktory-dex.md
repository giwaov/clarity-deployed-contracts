---
title: "Trait toony2-faktory-dex"
draft: true
---
```
    ...
    (define-constant DEX-TOKEN 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-faktory)
    ...
    (define-public (buy (ft <faktory-token>) (ubtc uint))
      (begin
        ...
        (let (
          ...
          (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
                      transfer pre-fee tx-sender 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-pre-faktory none))
          (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-pre-faktory create-fees-receipt pre-fee))) 
          (try! (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token 
          ...
          (if (>= new-stx TARGET_STX)
              (let ((premium-amount (/ (* new-ft (var-get premium)) u100))
                ...
                (try! (as-contract (contract-call? ft transfer premium-amount tx-sender 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-bonus-faktory none)))
                (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-bonus-faktory deposit-bonus agent-amount originator-amount)))
                (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-faktory-pool initialize-pool amm-ustx (- amm-amount amm-ustx))))
                ...
                (try! (as-contract (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-pre-faktory toggle-bonded))) 
    ...
    (define-public (open-market) 
      (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony2-pre-faktory is-market-open))))
