...
(define-public (open
  ...
  (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.gl-api open base-token quote-token long collateral leverage desired slippage ctx0)
)
...
(define-public (close
  ...
  (contract-call? 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.gl-api close base-token quote-token position-id desired slippage ctx0)
)
