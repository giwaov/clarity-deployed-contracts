---
title: "Trait test-hermetica-interface-hbtc-v6"
draft: true
---
```
...
(define-public (hermetica-stake
  ...
  (let (
    ...
    (try! (contract-call? .test-state-hbtc-v6 check-trading-auth (contract-of staking) none none none))
    (try! (contract-call? .test-reserve-hbtc-v6 transfer usdh-token amount current-contract))
    (try! (as-contract? ((with-ft usdh-token "*" amount)) (try! (contract-call? staking stake amount none))))
...
(define-public (hermetica-unstake
  ...
  (staking <staking-trait>))
  (let (
    (transfer-result (try! (contract-call? .test-reserve-hbtc-v6 transfer susdh-token amount current-contract)))
...
(define-public (hermetica-withdraw
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v6 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v6 check-trading-auth (contract-of staking-silo) none none none))
...
(define-public (hermetica-unstake-and-withdraw
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v6 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v6 check-trading-auth (contract-of staking) (some (contract-of staking-silo)) none none))
    (try! (contract-call? staking-silo withdraw claim-id))
...
(define-public (hermetica-mint
  ...
  (let (
    (minting-asset-data (contract-call? .test-state-hbtc-v6 get-asset (contract-of minting-asset)))
    ...
    (try! (contract-call? .test-hq-vaults-v6 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v6 check-trading-auth (contract-of minting-auto) none (some (contract-of minting-asset)) none))
    (try! (contract-call? .test-reserve-hbtc-v6 transfer minting-asset amount-asset current-contract))
    (try! (as-contract? ((with-all-assets-unsafe)) (try! (contract-call? minting-auto mint minting-asset amount-usdh slippage-tolerance memo price-feed execution-plan))))
...
(define-public (hermetica-redeem
  ...
  (let (
    (redeeming-asset-data (contract-call? .test-state-hbtc-v6 get-asset (contract-of redeeming-asset)))
    ...
    (try! (contract-call? .test-hq-vaults-v6 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v6 check-trading-auth (contract-of minting-auto) none (some (contract-of redeeming-asset)) none))    
    (try! (contract-call? .test-reserve-hbtc-v6 transfer usdh-token amount-usdh current-contract))
