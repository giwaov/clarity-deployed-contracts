...
(define-public (open
  ...
  (contract-call? 'SP1JZ89NV29EEGKJ10TH5ZQVRV9N9392FAQCMB5X8.gl-api open base-token quote-token long collateral leverage desired slippage ctx0)
)
...
(define-public (close
  ...
  (contract-call? 'SP1JZ89NV29EEGKJ10TH5ZQVRV9N9392FAQCMB5X8.gl-api close base-token quote-token position-id desired slippage ctx0)
)
