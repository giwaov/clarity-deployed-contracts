---
title: "Trait industrial-fuchsia-newt"
draft: true
---
```
...
;; Alex pool uses its own SIP-010 trait contract.
(use-trait alex-sip-010-trait 'SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.trait-sip-010.sip-010-trait)
...
(define-trait alex-pool-trait
  (
    (swap-helper-a
      (<alex-sip-010-trait> <alex-sip-010-trait> <alex-sip-010-trait> uint uint uint (optional uint))
      (response uint uint)
    )
  )
)
...
(define-public (execute-bitflow-alex-then-velar
  ...
  (alex-stx-token <alex-sip-010-trait>)
  (alex-alex-token <alex-sip-010-trait>)
  (alex-leo-token <alex-sip-010-trait>)
