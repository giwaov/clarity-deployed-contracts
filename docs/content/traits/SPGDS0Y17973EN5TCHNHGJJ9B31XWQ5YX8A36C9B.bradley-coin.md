...
(define-fungible-token bradley-coin)
...
(define-constant TOKEN_NAME "bradley coin ")
...
(define-public (mint
  ...
  (begin
    ...
    (ft-mint? bradley-coin amount recipient)
  )
)
...
(define-public (transfer
  ...
  (begin
    ...
    (try! (ft-transfer? bradley-coin amount sender recipient))
    (match memo
