...
(define-public (brazil
    (a1 (optional uint))
    (a2 (optional uint))
    (a3 (optional principal))
    (a4 (optional (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>) (d <ft-trait>))))
    (a5 (optional (tuple (a <xyk-pool-trait-v1-2>) (b <xyk-pool-trait-v1-2>))))
    (a6 (optional uint))
    (a7 (optional bool))
    (a8 (optional (tuple (a <ft-trait>) (b <ft-trait>))))
    (a9 (optional (tuple (a <xyk-pool-trait-v1-2>))))
    (a10 (optional (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>))))
...
(define-private (call-b
    ...
    (vt (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>)))
