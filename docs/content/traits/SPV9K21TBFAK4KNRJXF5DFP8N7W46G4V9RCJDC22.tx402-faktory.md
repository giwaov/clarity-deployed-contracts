---
title: "Trait tx402-faktory"
draft: true
---
```

;; d770e3d72a432661f958c5c5e4e7efc11bc70d86f3ae8905e51158caa166a337
;; tx402 Powered By Faktory.fun v1.0 
...
(define-fungible-token TX402 MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? TX402 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance TX402 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? TX402 (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.tx402-faktory-dex))
    (try! (ft-mint? TX402 (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.tx402-pre-faktory))
