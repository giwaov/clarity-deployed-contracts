...
(define-constant ERR-NOT-AUTHORIZED (err u3015))
(define-constant ERR-NOT-FOUND (err u3016))
(define-constant ERR-INVALID-INPUT (err u3017))
(define-constant ERR-ALREADY-EXISTS (err u3018))
