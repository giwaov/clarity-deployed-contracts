---
title: "Trait dlmm-pool-h-v-0-1"
draft: true
---
```
;; Implement DLMM pool trait, SIP 013 traits, and use SIP 010 trait
(impl-trait .dlmm-pool-trait-v-0-1.dlmm-pool-trait)
(impl-trait .sip-013-trait-sft-standard-v-0-1.sip-013-trait)
(impl-trait .sip-013-transfer-many-trait-v-0-1.sip-013-transfer-many-trait)
