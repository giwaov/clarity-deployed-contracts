---
title: "Trait stream-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SPYENKTRCJ0SSK5SKA0S0AW0QCH69Y4PM4VYQM7N.stream-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u789992897166758)
    (var-set stx-balance u26583417)
