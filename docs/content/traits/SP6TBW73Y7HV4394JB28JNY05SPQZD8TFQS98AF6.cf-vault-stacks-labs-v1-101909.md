---
title: "Trait cf-vault-stacks-labs-v1-101909"
draft: true
---
```
...
(use-trait wrapper-trait 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-traits-v0.wrapper-trait)
...
(define-private (calculate-fee (amount uint))
    (let (
            (fee-bps (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0 get-client-fee-bps CLIENT))
...
(define-private (assert-valid-caller)
    (let ((user (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0 get-user-id-by-address tx-sender)))
        (asserts!
            (or
                (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0 is-cofund-admin tx-sender)
...
(define-public (execute-transaction
    ...
    (begin
        ...
        (let (
                ...
                (policy (unwrap!
                    (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0 get-policy CLIENT
                        policy-id
                    )
                    ERR_INVALID_POLICY
                ))
    ...
    (begin
        ...
        (let (
            ...
            (let (
                    ...
                    (fee-recipient (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0
...
(define-private (verify-transaction-signature
    ...
    (begin
        ...
        (asserts!
            (is-none (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0 get-used-auth-ids CLIENT auth-id))
            ERR_AUTH_ID_REPLAY
        )
        ...
        ;; update auth-id
        (unwrap!
            (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0 set-auth-id CLIENT "vault"
                auth-id
            )
            ERR_AUTH_ID_REPLAY
        )
...
(define-private (verify-transaction-signature-helper
    ...
    (match signed-response
        ok-response (let (
                ...
                (user-id (get user-id
                    (unwrap!
                        (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0
                            get-user-id-by-address signer-address
                        )
                        ERR_INVALID_USER
                    )))
                (user (unwrap!
                    (contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0 get-user CLIENT user-id)
                    ERR_INVALID_USER
                ))
            )
...
(contract-call? 'SP6TBW73Y7HV4394JB28JNY05SPQZD8TFQS98AF6.cf-helpers-state-v0 new-client CLIENT 0xa79218f81e11e39561197e029d2c4c4353943914305cf3dc5aac61236950271f "314bba3e-c725-4604-8cdd-032e6712a14f" "BUSINESS")
