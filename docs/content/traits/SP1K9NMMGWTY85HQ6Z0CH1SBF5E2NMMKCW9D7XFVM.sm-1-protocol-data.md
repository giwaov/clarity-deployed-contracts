---
title: "Trait sm-1-protocol-data"
draft: true
---
```
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(define-constant UNDERLYING-STX .sm-wstx)
...
(define-private (get-vault-interest-rate (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-interest-rate))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-interest-rate))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-interest-rate))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-interest-rate))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-interest-rate))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-interest-rate))
  u0)))))))

;; -- Vault routing: get utilization -----------------------------------------

(define-private (get-vault-utilization (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-utilization))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-utilization))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-utilization))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-utilization))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-utilization))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-utilization))
  u0)))))))

;; -- Vault routing: get fee reserve -----------------------------------------

(define-private (get-vault-fee-reserve (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-fee-reserve))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-fee-reserve))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-fee-reserve))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-fee-reserve))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-fee-reserve))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-fee-reserve))
  u0)))))))

;; -- Vault routing: get total assets ----------------------------------------

(define-private (get-vault-total-assets (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-total-assets))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-total-assets))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-total-assets))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-total-assets))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-total-assets))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-total-assets))
  u0)))))))

;; -- Vault routing: get debt ------------------------------------------------

(define-private (get-vault-debt (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-debt))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-debt))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-debt))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-debt))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-debt))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-debt))
  u0)))))))

;; -- Vault routing: get total supply ----------------------------------------

(define-private (get-vault-total-supply (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-total-supply))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-total-supply))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-total-supply))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-total-supply))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-total-supply))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-total-supply))
  u0)))))))

;; -- Vault routing: get borrow index ----------------------------------------

(define-private (get-vault-borrow-index (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-index))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-index))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-index))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-index))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-index))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-index))
  INDEX-PRECISION)))))))

;; -- Vault routing: get liquidity index -------------------------------------

(define-private (get-vault-liquidity-index (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-liquidity-index))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-liquidity-index))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-liquidity-index))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-liquidity-index))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-liquidity-index))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-liquidity-index))
  INDEX-PRECISION)))))))

;; -- Vault routing: get cap supply ------------------------------------------

(define-private (get-vault-cap-supply (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-cap-supply))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-cap-supply))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-cap-supply))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-cap-supply))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-cap-supply))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-cap-supply))
  u0)))))))

;; -- Vault routing: get cap debt --------------------------------------------

(define-private (get-vault-cap-debt (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-cap-debt))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-cap-debt))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-cap-debt))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-cap-debt))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-cap-debt))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-cap-debt))
  u0)))))))

;; -- Vault routing: get last update -----------------------------------------

(define-private (get-vault-last-update (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-last-update))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-last-update))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-last-update))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-last-update))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-last-update))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-last-update))
  u0)))))))

;; -- Vault routing: get points util -----------------------------------------

(define-private (get-vault-points-util (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-points-util))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-points-util))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-points-util))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-points-util))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-points-util))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-points-util))
  (list u0 u0 u0 u0 u0 u0 u0 u0))))))))

;; -- Vault routing: get points rate -----------------------------------------

(define-private (get-vault-points-rate (vid uint))
  (if (is-eq vid STX) (unwrap-panic (contract-call? .sm-vault-stx get-points-rate))
  (if (is-eq vid sBTC) (unwrap-panic (contract-call? .sm-vault-sbtc get-points-rate))
  (if (is-eq vid stSTX) (unwrap-panic (contract-call? .sm-vault-ststx get-points-rate))
  (if (is-eq vid USDC) (unwrap-panic (contract-call? .sm-vault-usdc get-points-rate))
  (if (is-eq vid USDH) (unwrap-panic (contract-call? .sm-vault-usdh get-points-rate))
  (if (is-eq vid stSTXbtc) (unwrap-panic (contract-call? .sm-vault-ststxbtc get-points-rate))
  (list u0 u0 u0 u0 u0 u0 u0 u0))))))))
...
(define-private (get-vault-underlying-balance (vid uint) (account principal))
  (if (is-eq vid STX)
      (let ((shares (unwrap-panic (contract-call? .sm-vault-stx get-balance account))))
        (unwrap-panic (contract-call? .sm-vault-stx convert-to-assets shares)))
  (if (is-eq vid sBTC)
      (let ((shares (unwrap-panic (contract-call? .sm-vault-sbtc get-balance account))))
        (unwrap-panic (contract-call? .sm-vault-sbtc convert-to-assets shares)))
  (if (is-eq vid stSTX)
      (let ((shares (unwrap-panic (contract-call? .sm-vault-ststx get-balance account))))
        (unwrap-panic (contract-call? .sm-vault-ststx convert-to-assets shares)))
  (if (is-eq vid USDC)
      (let ((shares (unwrap-panic (contract-call? .sm-vault-usdc get-balance account))))
        (unwrap-panic (contract-call? .sm-vault-usdc convert-to-assets shares)))
  (if (is-eq vid USDH)
      (let ((shares (unwrap-panic (contract-call? .sm-vault-usdh get-balance account))))
        (unwrap-panic (contract-call? .sm-vault-usdh convert-to-assets shares)))
  (if (is-eq vid stSTXbtc)
      (let ((shares (unwrap-panic (contract-call? .sm-vault-ststxbtc get-balance account))))
        (unwrap-panic (contract-call? .sm-vault-ststxbtc convert-to-assets shares)))
  u0)))))))
...
(define-private (get-vault-available-liquidity (vid uint))
  (if (is-eq vid STX) (contract-call? .sm-vault-stx get-available-assets)
  (if (is-eq vid sBTC) (contract-call? .sm-vault-sbtc get-available-assets)
  (if (is-eq vid stSTX) (contract-call? .sm-vault-ststx get-available-assets)
  (if (is-eq vid USDC) (contract-call? .sm-vault-usdc get-available-assets)
  (if (is-eq vid USDH) (contract-call? .sm-vault-usdh get-available-assets)
  (if (is-eq vid stSTXbtc) (contract-call? .sm-vault-ststxbtc get-available-assets)
  u0)))))))
...
(define-private (iter-build-asset (id uint) (acc { max-id: uint, result: (list 128 {
  ...
  (let ((max-id (get max-id acc)))
    (if (>= id max-id)
        acc
        (let ((asset-status (unwrap-panic (contract-call? .sm-assets get-status id)))
              (entry {
                id: id,
...
(define-private (iter-build-egroup (id uint) (acc { max-id: uint, result: (list 128 {
  ...
  (let ((max-id (get max-id acc)))
    (if (>= id max-id)
        acc
        (let ((egroup-data (contract-call? .sm-egroup lookup id))
              (entry {
                id: id,
...
(define-read-only (get-user-position (account principal))
  (let ((enabled-mask (contract-call? .sm-assets get-bitmap)))
    (match (contract-call? .sm-market-vault get-position account enabled-mask)
      position
        (let ((mask (get mask position))
              ...
              (egroup-result (contract-call? .sm-egroup resolve mask)))
          (match egroup-result
            egroup
...
(define-private (build-debt-entry (debt-entry { aid: uint, scaled: uint }))
  (let ((aid (get aid debt-entry))
        ...
        (asset-status (unwrap-panic (contract-call? .sm-assets get-status aid)))
...
(define-private (sum-collateral-usd (entry { aid: uint, amount: uint }) (acc uint))
  (let ((aid (get aid entry))
        ...
        (asset-data (unwrap-panic (contract-call? .sm-assets get-status aid)))
...
(define-read-only (get-all-assets)
  (let ((nonce (unwrap-panic (contract-call? .sm-assets get-nonce)))
...
(define-read-only (get-all-egroups)
  (let ((nonce (unwrap-panic (contract-call? .sm-egroup get-nonce)))
        (init { max-id: nonce, result: (list) })
...
(define-read-only (get-protocol-summary)
  (let ((stx-data (build-reserve-data STX))
    ...
    (ok {
      ...
      asset-count: (unwrap-panic (contract-call? .sm-assets get-nonce)),
      egroup-count: (unwrap-panic (contract-call? .sm-egroup get-nonce))
    })))
...
(define-read-only (get-supplies-user (account principal))
  (let ((enabled-mask (contract-call? .sm-assets get-bitmap))
        ...
        (vault-stx-shares (unwrap-panic (contract-call? .sm-vault-stx get-balance account)))
        (vault-sbtc-shares (unwrap-panic (contract-call? .sm-vault-sbtc get-balance account)))
        (vault-ststx-shares (unwrap-panic (contract-call? .sm-vault-ststx get-balance account)))
        (vault-usdc-shares (unwrap-panic (contract-call? .sm-vault-usdc get-balance account)))
        (vault-usdh-shares (unwrap-panic (contract-call? .sm-vault-usdh get-balance account)))
        (vault-ststxbtc-shares (unwrap-panic (contract-call? .sm-vault-ststxbtc get-balance account))))
...
(define-read-only (get-all-vault-ratios)
  (ok {
    stx: {
      vault-id: STX,
      shares-to-assets: (unwrap-panic (contract-call? .sm-vault-stx convert-to-assets u1000000)),
      underlying: UNDERLYING-STX
    },
    sbtc: {
      vault-id: sBTC,
      shares-to-assets: (unwrap-panic (contract-call? .sm-vault-sbtc convert-to-assets u100000000)),
      underlying: UNDERLYING-SBTC
    },
    ststx: {
      vault-id: stSTX,
      shares-to-assets: (unwrap-panic (contract-call? .sm-vault-ststx convert-to-assets u1000000)),
      underlying: UNDERLYING-STSTX
    },
    usdc: {
      vault-id: USDC,
      shares-to-assets: (unwrap-panic (contract-call? .sm-vault-usdc convert-to-assets u1000000)),
      underlying: UNDERLYING-USDC
    },
    usdh: {
      vault-id: USDH,
      shares-to-assets: (unwrap-panic (contract-call? .sm-vault-usdh convert-to-assets u100000000)),
      underlying: UNDERLYING-USDH
    },
    ststxbtc: {
      vault-id: stSTXbtc,
      shares-to-assets: (unwrap-panic (contract-call? .sm-vault-ststxbtc convert-to-assets u1000000)),
...
(define-read-only (get-market-vault-balances)
  (ok {
    ...
    underlying: {
      wstx: (unwrap-panic (contract-call? .sm-wstx get-balance .sm-market-vault)),
    ...
    ztokens: {
      vault-stx: (unwrap-panic (contract-call? .sm-vault-stx get-balance .sm-market-vault)),
      vault-sbtc: (unwrap-panic (contract-call? .sm-vault-sbtc get-balance .sm-market-vault)),
      vault-ststx: (unwrap-panic (contract-call? .sm-vault-ststx get-balance .sm-market-vault)),
      vault-usdc: (unwrap-panic (contract-call? .sm-vault-usdc get-balance .sm-market-vault)),
      vault-usdh: (unwrap-panic (contract-call? .sm-vault-usdh get-balance .sm-market-vault)),
      vault-ststxbtc: (unwrap-panic (contract-call? .sm-vault-ststxbtc get-balance .sm-market-vault))
    }
  }))
...
(define-read-only (get-user-sbtc-balances (account principal))
  (let (
    (vault-shares (unwrap-panic (contract-call? .sm-vault-sbtc get-balance account)))
    (vault-underlying (unwrap-panic (contract-call? .sm-vault-sbtc convert-to-assets vault-shares)))
    
    (market-sbtc
      (match (contract-call? .sm-market-vault get-position account u4)  ;; mask = 2^2 = 4 (sBTC collateral bit)
        position
