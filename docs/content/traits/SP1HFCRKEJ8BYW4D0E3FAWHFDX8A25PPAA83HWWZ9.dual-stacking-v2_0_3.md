---
title: "Trait dual-stacking-v2_0_3"
draft: true
---
```
...
(define-data-var cycle-id uint u6)
...
(var-set current-cycle-bitcoin-block-height u934750)
...
(define-read-only (get-defi-sbtc-balance (user {
  ...
  (contract-call? .sbtc-holdings-defi-v2_2
