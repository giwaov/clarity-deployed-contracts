---
title: "Trait test-reserve-hbtc-v4"
draft: true
---
```
;; @contract Reserve
...
(define-public (transfer (asset <ft>) (amount uint) (recipient principal))
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v4 check-is-protocol-two contract-caller recipient))
    (try! (contract-call? .test-state-hbtc-v4 check-transfer-auth (contract-of asset)))
