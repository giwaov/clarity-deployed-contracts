---
title: "Trait toony4-faktory"
draft: true
---
```

;; 
;; toony4 Powered By Faktory.fun v1.0 
...
(define-fungible-token TOONY4 MAX)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? TOONY4 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
(define-read-only (get-balance (account principal))
  (ok (ft-get-balance TOONY4 account))
)
...
(begin 
    ;; ft distribution
    (try! (ft-mint? TOONY4 (/ (* MAX u80) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony4-faktory-dex))
    (try! (ft-mint? TOONY4 (/ (* MAX u20) u100) 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.toony4-pre-faktory))
