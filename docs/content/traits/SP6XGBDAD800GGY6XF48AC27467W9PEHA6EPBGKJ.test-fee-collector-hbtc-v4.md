---
title: "Trait test-fee-collector-hbtc-v4"
draft: true
---
```
...
(define-public (withdraw (asset <ft>))
  (let (
    ...
    (fee-address (contract-call? .test-state-hbtc-v4 get-fee-address))
  )
    (try! (contract-call? .test-state-hbtc-v4 check-is-transfer-active))
    (try! (contract-call? .test-state-hbtc-v4 check-is-asset asset-contract))
