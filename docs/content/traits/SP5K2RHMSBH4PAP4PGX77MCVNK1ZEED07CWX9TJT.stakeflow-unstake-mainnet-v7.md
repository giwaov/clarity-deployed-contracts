---
title: "Trait stakeflow-unstake-mainnet-v7"
draft: true
---
```
;; StakeFlow Unstake Contract V7
;; Unstake NFTs and claim rewards (0.001 STX fee)
;; MAINNET VERSION V7 - References staking-v7 and rewards-v7
...
(define-public (unstake-nft (token-id uint))
  (let
    ...
    (try! (contract-call? 'SP5K2RHMSBH4PAP4PGX77MCVNK1ZEED07CWX9TJT.stakeflow-rewards-mainnet-v7 claim-and-distribute token-id staker))
    ;; Remove stake and return NFT
    (try! (contract-call? 'SP5K2RHMSBH4PAP4PGX77MCVNK1ZEED07CWX9TJT.stakeflow-staking-mainnet-v7 release-nft token-id staker))
