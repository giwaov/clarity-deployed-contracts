---
title: "Trait stacks-index-oneclick-v49"
draft: true
---
```
;; =====================================================================
...
(define-public (sell-portfolio
  ...
  (begin
    ...
    ;; Sell ALEX -> USDCx (two-step: ALEX -> STX via Alex AMM, then STX -> USDCx)
    (if (> alex-amount u0)
      (let
        (
          ;; Step 1: ALEX -> STX via Alex AMM swap-helper (direct 1-hop)
          ;; swap-helper returns (response uint uint) - just the output amount
        ...
        ;; Step 2: STX -> USDCx via Bitflow
        (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.router-stableswap-xyk-v-1-5 swap-helper-a
          stx-from-alex alex-usdcx-min-out none true  ;; reversed = true
          { a: 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc, b: 'SP120SBRBQJ00MCWS7TM5R8WJNTTKD5K0HFRC2CNE.usdcx }
          { a: 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-aeusdc-usdcx-v-1-1 }
          { a: 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.token-stx-v-1-1, b: 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc }
          { a: 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-pool-stx-aeusdc-v-1-1 }
    ...
    ;; Sell VELAR -> USDCx (two-step: VELAR -> STX via Velar, then STX -> USDCx)
    (if (> velar-amount u0)
      (let
        (
          ;; Step 1: VELAR -> STX via Velar path-apply
          ;; Velar path-apply returns tuple {swap1: {amt-in, amt-out}, swap2: ..., swap3: ..., swap4: ...}
          ;; For 1-hop swap, output is in swap1.amt-out
          (velar-swap-result (unwrap! (contract-call? 'SP20X3DC5R091J8B6YPQT638J8NR1W83KN6TN5BJY.path-apply_staging apply
            ...
            velar-amount  ;; amt-in
            (some 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.velar-token)  ;; token1
            (some 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.wstx)          ;; token2
            none  ;; token3
            none  ;; token4
            none  ;; token5
            (some 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.univ2-share-fee-to)  ;; share-fee-to
        ...
        ;; Step 2: STX -> USDCx via Bitflow
        (unwrap! (contract-call? 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.router-stableswap-xyk-v-1-5 swap-helper-a
          stx-from-velar velar-usdcx-min-out none true  ;; reversed = true
          { a: 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc, b: 'SP120SBRBQJ00MCWS7TM5R8WJNTTKD5K0HFRC2CNE.usdcx }
          { a: 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.stableswap-pool-aeusdc-usdcx-v-1-1 }
          { a: 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.token-stx-v-1-1, b: 'SP3Y2ZSH8P7D50B0VBTSX11S7XSG24M1VB9YFQA4K.token-aeusdc }
          { a: 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-pool-stx-aeusdc-v-1-1 }
    ...
    (print { event: "sell-portfolio", seller: tx-sender, stx: stx-amount, sbtc: sbtc-amount, ststx: ststx-amount, welsh: welsh-amount, leo: leo-amount, dog: dog-amount, droid: droid-amount, usdh: usdh-amount, alex: alex-amount, velar: velar-amount })
    (ok { sold-stx: stx-amount, sold-sbtc: sbtc-amount, sold-ststx: ststx-amount, sold-welsh: welsh-amount, sold-leo: leo-amount, sold-dog: dog-amount, sold-droid: droid-amount, sold-usdh: usdh-amount, sold-alex: alex-amount, sold-velar: velar-amount })
  )
)
