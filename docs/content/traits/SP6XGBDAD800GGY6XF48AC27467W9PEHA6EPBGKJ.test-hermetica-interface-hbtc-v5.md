---
title: "Trait test-hermetica-interface-hbtc-v5"
draft: true
---
```
...
(define-public (hermetica-mint
  ...
  (let (
    ...
    (let (
      ...
      (if (> leftover u0)
        (try! (as-contract (contract-call? minting-asset transfer leftover this-contract reserve none)))
        true
      )
...
(define-public (hermetica-redeem
  ...
  (let (
    ...
    (let (
      ...
      (try! (as-contract (contract-call? redeeming-asset transfer asset-received this-contract reserve none)))
