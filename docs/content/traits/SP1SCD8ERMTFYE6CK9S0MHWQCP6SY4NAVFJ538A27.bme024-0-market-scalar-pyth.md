---
title: "Trait bme024-0-market-scalar-pyth"
draft: true
---
```
...
(define-private (get-current-price-safe (feed-id (buff 32)))
  (let (
      (d         (unwrap! (contract-call? 'SP1CGXWEAMG6P6FT04W66NVGJ7PQWMDAC19R7PJ0Y.pyth-oracle-v4 get-price feed-id 'SP1CGXWEAMG6P6FT04W66NVGJ7PQWMDAC19R7PJ0Y.pyth-storage-v4) err-oracle-call-failed))
