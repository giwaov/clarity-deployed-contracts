---
title: "Trait test-hermetica-interface-hbtc-v4"
draft: true
---
```
...
(define-public (hermetica-stake
  ...
  (let (
    ...
    (try! (contract-call? .test-state-hbtc-v4 check-trading-auth (contract-of staking-trait) none none none))
    (try! (contract-call? .test-reserve-hbtc-v4 transfer usdh-token amount this-contract))
...
(define-public (hermetica-unstake
  ...
  (staking-trait <staking>))
  (let (
    (transfer-result (try! (contract-call? .test-reserve-hbtc-v4 transfer susdh-token amount this-contract)))
...
(define-public (hermetica-withdraw
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v4 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v4 check-trading-auth (contract-of staking-silo-trait) none none none))
...
(define-public (hermetica-unstake-and-withdraw
  ...
  (let (
    ...
    (try! (contract-call? .test-hq-vaults-v4 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v4 check-trading-auth (contract-of staking-trait) (some (contract-of staking-silo-trait)) none none))
    (try! (as-contract (contract-call? staking-silo-trait withdraw claim-id)))
...
(define-public (hermetica-mint
  ...
  (let (
    (minting-asset-data (contract-call? .test-state-hbtc-v4 get-asset (contract-of minting-asset-trait)))
    ...
    (pre-balance (unwrap-panic (contract-call? minting-asset-trait get-balance this-contract)))
  )
    (try! (contract-call? .test-hq-vaults-v4 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v4 check-trading-auth (contract-of minting-auto-trait) none (some (contract-of minting-asset-trait)) none))
    (try! (contract-call? .test-reserve-hbtc-v4 transfer minting-asset-trait amount-asset this-contract))
    ...
    (let (
      (post-balance (unwrap-panic (contract-call? minting-asset-trait get-balance this-contract)))
      (leftover (if (> post-balance pre-balance) (- post-balance pre-balance) u0))
    )
      (if (> leftover u0)
        (try! (as-contract (contract-call? minting-asset-trait transfer leftover this-contract reserve none)))
        true
      )
      ...
      (print { action: "hermetica-mint", user: contract-caller, data: { minting-asset: minting-asset-trait, amount-asset: amount-asset, usdh-received: amount-usdh, leftover: leftover, minting-contract: minting-auto-trait } })
      (ok amount-usdh)
    )
  )
)
...
(define-public (hermetica-redeem
  ...
  (let (
    (redeeming-asset-data (contract-call? .test-state-hbtc-v4 get-asset (contract-of redeeming-asset-trait)))
    ...
    (try! (contract-call? .test-hq-vaults-v4 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v4 check-trading-auth (contract-of minting-auto-trait) none (some (contract-of redeeming-asset-trait)) none))    
    (try! (contract-call? .test-reserve-hbtc-v4 transfer usdh-token amount-usdh this-contract))
...
(define-public (sweep (asset-trait <ft>) (amount uint))
  (begin
    (try! (contract-call? .test-hq-vaults-v4 check-is-trader contract-caller))
    (try! (contract-call? .test-state-hbtc-v4 check-is-asset (contract-of asset-trait)))
