...
(define-private (vault-deposit (aid uint) (amount uint) (min-out uint) (recipient principal))
  (if (is-eq aid STX) (contract-call? .staging-vault-stx-v0 deposit amount min-out recipient)
  (if (is-eq aid sBTC) (contract-call? .staging-vault-sbtc-v0 deposit amount min-out recipient)
  (if (is-eq aid stSTX) (contract-call? .staging-vault-ststx-v0 deposit amount min-out recipient)
  (if (is-eq aid USDC) (contract-call? .staging-vault-usdc-v0 deposit amount min-out recipient)
  (if (is-eq aid USDH) (contract-call? .staging-vault-usdh-v0 deposit amount min-out recipient)
  ERR-UNKNOWN-VAULT))))))

(define-private (vault-redeem (aid uint) (amount uint) (min-out uint) (recipient principal))
  (if (is-eq aid STX) (contract-call? .staging-vault-stx-v0 redeem amount min-out recipient)
  (if (is-eq aid sBTC) (contract-call? .staging-vault-sbtc-v0 redeem amount min-out recipient)
  (if (is-eq aid stSTX) (contract-call? .staging-vault-ststx-v0 redeem amount min-out recipient)
  (if (is-eq aid USDC) (contract-call? .staging-vault-usdc-v0 redeem amount min-out recipient)
  (if (is-eq aid USDH) (contract-call? .staging-vault-usdh-v0 redeem amount min-out recipient)
  ERR-UNKNOWN-VAULT))))))
...
(define-public (supply-collateral-add (ft <ft-trait>) (amount uint) (min-shares uint) (price-feeds (optional (list 3 (buff 8192)))))
  (let ((ft-address (contract-of ft))
    ...
    (let ((shares-minted 
      ...
      (if (is-eq asset-id STX) (collateral-add .staging-vault-stx-v0 shares-minted price-feeds)
      (if (is-eq asset-id sBTC) (collateral-add .staging-vault-sbtc-v0 shares-minted price-feeds)
      (if (is-eq asset-id stSTX) (collateral-add .staging-vault-ststx-v0 shares-minted price-feeds)
      (if (is-eq asset-id USDC) (collateral-add .staging-vault-usdc-v0 shares-minted price-feeds)
      (if (is-eq asset-id USDH) (collateral-add .staging-vault-usdh-v0 shares-minted price-feeds)
      ERR-UNKNOWN-VAULT)))))))
)
