...
;; Min core migration cooldown in seconds (10 minutes min)
(define-constant MIN_CORE_MIGRATION_COOLDOWN u600)
...
(define-data-var core-migration-cooldown uint u600)
