...
;; Import traits
(use-trait liquidator-trait-v3 .liquidator-trait-v3.liquidator-trait-v3)

;; Constants
;; Note: contract-owner should be set via set-admin after deployment
(define-constant CONTRACT-ADDRESS .lending-pool-v3)
...
(define-public (liquidate
        (borrower principal)
        (liquidator <liquidator-trait-v3>)
    )
    (let (
