---
title: "Trait collateral-backed-loan"
draft: true
---
```

;; collateral-backed-loan.clar
;; Users lock STX collateral to borrow a SIP-010 token.
;; CLARITY VERSION: 2
...
(define-public (borrow (borrow-amount uint) (collateral-amount uint) (token-trait <sip-010-trait>))
    (let (
        (sender tx-sender)
...
(define-public (repay (repay-amount uint) (token-trait <sip-010-trait>))
    (let (
        (sender tx-sender)
