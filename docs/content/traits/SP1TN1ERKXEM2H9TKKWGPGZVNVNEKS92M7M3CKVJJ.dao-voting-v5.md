---
title: "Trait dao-voting-v5"
draft: true
---
```

;; DAO Voting v5 (`dao-voting-v5`)
;; Linked to soulbound-badge-v3
...
(define-public (create-proposal (title (string-ascii 64)) (duration uint))
    (begin
        ;; Gatekeeping: Must hold a Soulbound Badge v3 to propose
        (asserts! (> (unwrap! (contract-call? .soulbound-badge-v3 get-last-token-id) (err u0)) u0) ERR-NO-BADGE) 
...
(define-public (vote (proposal-id uint) (vote-for (string-ascii 10)))
    (let
        ...
        ;; Gatekeeping: Must hold a Soulbound Badge v3 to vote
        (asserts! (> (unwrap! (contract-call? .soulbound-badge-v3 get-last-token-id) (err u0)) u0) ERR-NO-BADGE)
