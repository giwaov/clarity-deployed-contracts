---
title: "Trait ballot-testing--azaer"
draft: true
---
```
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        (define-private (get-voting-power-by-ft-holdings)
            (at-block (unwrap-panic (get-stacks-block-info? id-header-hash u5411946))
                (let
                    (
    ...
    ;; Default assignments
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (var-set title u"Testing%20")
    (var-set description u"")
    (var-set voting-system "fptp")
    (var-set options (list "93c58ce8-02fe-41ac-8e77-3ac6924f3c69" "14caff59-9820-4e0f-831a-6e5603f3e3e7"))
    (var-set start u928753)
    (var-set end u928759)
    (map-set results {id: "93c58ce8-02fe-41ac-8e77-3ac6924f3c69"} {count: u0, name: u"Yes", locked-stx: u0, unlocked-stx: u0}) (map-set results {id: "14caff59-9820-4e0f-831a-6e5603f3e3e7"} {count: u0, name: u"No", locked-stx: u0, unlocked-stx: u0})
```
