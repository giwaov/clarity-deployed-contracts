  ...
  (let (
    ...
    (if ststx-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1A27KFY4XERQCCRCARCYD1CC5N7M6688BSYADJ7.v0-vault-ststx
            deposit
            token-balance
            u0
            account
    ...
    (if wstx-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1A27KFY4XERQCCRCARCYD1CC5N7M6688BSYADJ7.v0-vault-stx
            deposit
            token-balance
            u0
            account
    ...
    (if usdh-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1A27KFY4XERQCCRCARCYD1CC5N7M6688BSYADJ7.v0-vault-usdh
            deposit
            token-balance
            u0
            account
    ...
    (if sbtc-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1A27KFY4XERQCCRCARCYD1CC5N7M6688BSYADJ7.v0-vault-sbtc
            deposit
            token-balance
            u0
            account
    ...
    (if ststxbtc-withdraw
      (let (
        ...
        (try! (as-contract? ((with-all-assets-unsafe))
          (try! (contract-call? 'SP1A27KFY4XERQCCRCARCYD1CC5N7M6688BSYADJ7.v0-vault-ststxbtc
            deposit
            token-balance
            u0
            account
