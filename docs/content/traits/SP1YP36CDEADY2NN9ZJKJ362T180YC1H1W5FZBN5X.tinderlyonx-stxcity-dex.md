---
title: "Trait tinderlyonx-stxcity-dex"
draft: true
---
```
...
(define-constant allow-token 'SP1YP36CDEADY2NN9ZJKJ362T180YC1H1W5FZBN5X.tinderlyonx-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u14000000000000000)
    (var-set stx-balance u50000000)
