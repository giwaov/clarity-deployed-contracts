---
title: "Trait dual-stacking-v2_0_1-testing"
draft: true
---
```
...
(define-data-var bitcoin-blocks-per-year uint u3500)
...
(var-set current-cycle-bitcoin-block-height u927293)
(var-set snapshots-per-cycle u3)
(var-set blocks-per-snapshot u40)
(var-set buffer-blocks-per-cycle u20)
