...
(use-trait quest-types-trait .quest-types-trait-v1.quest-types-trait)
(impl-trait .quest-registry-trait-v1.quest-registry-trait)
...
(define-public (create-quest (name (string-utf8 64)) (type-id uint) (xp-reward uint) (badge-uri (string-utf8 256)))
  (begin
    ...
    (let ((type-entry (unwrap! (contract-call? .quest-types-v1 get-type type-id) err-type-missing)))
