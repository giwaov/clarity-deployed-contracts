---
title: "Trait fee-collector-hbtc-v1"
draft: true
---
```
...
(define-public (withdraw (asset <ft>))
  (let (
    ...
    (fee-address (contract-call? .state-hbtc-v1 get-fee-address))
  )
    (try! (contract-call? .state-hbtc-v1 check-is-transfer-enabled))
    (try! (contract-call? .state-hbtc-v1 check-is-asset asset-contract))
