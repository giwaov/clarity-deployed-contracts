...
draft: true
---
Deployer: SP2TRSJJMSX0J0GDBNCEG0Y1AQW26G3HYM9K4WCJG
...
Block height: 6210246 (2026-01-30T07:12:25.000Z)

Source code: {{<contractref "governance-v1" SP2TRSJJMSX0J0GDBNCEG0Y1AQW26G3HYM9K4WCJG governance-v1>}}

Functions:

* accrue-interest _private_
* add-guardian _private_
...
* execute-add-flash-loan-contract _private_
* execute-allow-any-contract-flash-loan _private_
...
* execute-remove-flash-loan-contract _private_
* execute-set-collateral-cap _private_
* execute-set-debt-cap _private_
* execute-set-decay-time-window _private_
* execute-set-lp-cap _private_
* execute-set-refill-time-window _private_
...
* execute-update-flash-loan-fee _private_
...
* get-proposal-execution-time _private_
* has-submitted-vote _private_
* is-already-guardian _private_
* remove-guardian _private_
...
* initiate-proposal-to-update-allow-any-flash-loan _public_
...
* initiate-proposal-to-update-flash-loan-contract _public_
* initiate-proposal-to-update-flash-loan-fee _public_
...
* initiate-proposal-to-update-withdrawal-caps-param _public_
