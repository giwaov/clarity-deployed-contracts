---
title: "Contract test-state-hbtc-v5"
draft: true
---
...
Block height: 5139881 (2025-12-05T16:12:19.000Z)

Source code: {{<contractref "test-state-hbtc-v5" SP6XGBDAD800GGY6XF48AC27467W9PEHA6EPBGKJ test-state-hbtc-v5>}}

Functions:

* execute-update _private_
* get-current-ts _private_
* remove-custom-cooldown-iter _private_
* remove-custom-exit-fee-iter _private_
* set-custom-cooldown-iter _private_
...
* request-new-asset _public_
* request-new-contract _public_
* set-cooldown _public_
* set-custom-cooldown _public_
* set-custom-exit-fee _public_
* set-deposit-active _public_
* set-deposit-cap _public_
* set-express-active _public_
* set-express-cooldown _public_
* set-fee-address _public_
* set-fees _public_
* set-max-deviation _public_
* set-max-reward _public_
* set-max-slippage _public_
* set-min-deposit _public_
* set-min-redeem _public_
* set-redeem-active _public_
* set-reserve-rate _public_
* set-staleness-window _public_
* set-trading-active _public_
* set-transfer-active _public_
* set-update-window _public_
* set-vault-active _public_
* test-set-total-assets _public_
* update-state _public_
* check-is-asset _read_only_
* check-is-contract _read_only_
* check-is-deposit-active _read_only_
* check-is-express-active _read_only_
* check-is-redeem-active _read_only_
* check-is-trading-active _read_only_
* check-is-transfer-active _read_only_
* check-is-vault-active _read_only_
* check-max-deviation _read_only_
* check-max-reward _read_only_
* check-redeem-auth _read_only_
...
* get-deposit-active _read_only_
* get-deposit-cap _read_only_
* get-deposit-state _read_only_
* get-express-active _read_only_
...
* get-trading-active _read_only_
* get-transfer-active _read_only_
* get-update-window _read_only_
* get-vault-active _read_only_
