...
(define-public (execute)
  (begin
    ;; INITIALIZE ASSETS
    (try! (contract-call? .vault-stx set-token-uri (some u"https://token-meta.s3.eu-central-1.amazonaws.com/zwSTX.json")))
    (try! (contract-call? .vault-sbtc set-token-uri (some u"https://token-meta.s3.eu-central-1.amazonaws.com/zsBTC.json")))
    (try! (contract-call? .vault-ststx set-token-uri (some u"https://token-meta.s3.eu-central-1.amazonaws.com/zstSTX.json")))
    (try! (contract-call? .vault-ststxbtc set-token-uri (some u"https://token-meta.s3.eu-central-1.amazonaws.com/zstSTXbtc.json")))
    (try! (contract-call? .vault-usdc set-token-uri (some u"https://token-meta.s3.eu-central-1.amazonaws.com/zusdcx.json")))
    (try! (contract-call? .vault-usdh set-token-uri (some u"https://token-meta.s3.eu-central-1.amazonaws.com/zUSDh.json")))
    ...
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u6290339729134957101060, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u3000, LTV-LIQ-PARTIAL: u4000, LTV-LIQ-FULL: u5000 }))
    ;; Egroup 2: sBTC collateral + sBTC debt (80% LTV)
    ;; MASK = 2^2 + 2^66 = 4 + 73786976294838206464 = 73786976294838206468
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u73786976294838206468, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u8000, LTV-LIQ-PARTIAL: u8500, LTV-LIQ-FULL: u9000 }))

    ;; Egroup 3: zsBTC collateral + USDC+USDh debt (70% LTV)
    ;; MASK = 2^3 + 2^70 + 2^72 = 8 + 5902958103587056517120 = 5902958103587056517128
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u5902958103587056517128, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u6000, LTV-LIQ-PARTIAL: u6500, LTV-LIQ-FULL: u7000 }))
    ;; Egroup 4: zSTX collateral + USDC+USDh debt (40% LTV)
    ;; MASK = 2^1 + 2^70 + 2^72 = 2 + 5902958103587056517120 = 5902958103587056517122
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u5902958103587056517122, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u4000, LTV-LIQ-PARTIAL: u5500, LTV-LIQ-FULL: u6000 }))
    ;; Egroup 5: zstSTX collateral + USDC+USDh debt (40% LTV)
    ;; MASK = 2^5 + 2^70 + 2^72 = 32 + 5902958103587056517120 = 5902958103587056517152
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u5902958103587056517152, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u4000, LTV-LIQ-PARTIAL: u5500, LTV-LIQ-FULL: u6000 }))
    ;; Egroup 6: zUSDC collateral + STX debt (30% LTV)
    ;; MASK = 2^7 + 2^64 = 128 + 18446744073709551616 = 18446744073709551744
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u18446744073709551744, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u3000, LTV-LIQ-PARTIAL: u4000, LTV-LIQ-FULL: u4500 }))
    ...
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u6290339729134957101064, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u3000, LTV-LIQ-PARTIAL: u4000, LTV-LIQ-FULL: u5000 }))
    ...
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u6290339729134957101058, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u2000, LTV-LIQ-PARTIAL: u3000, LTV-LIQ-FULL: u4000 }))
    ...
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u6290339729134957101088, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u2000, LTV-LIQ-PARTIAL: u3000, LTV-LIQ-FULL: u4000 }))
    ...
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u313594649253062377474, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u8000, LTV-LIQ-PARTIAL: u8500, LTV-LIQ-FULL: u9000 }))
    ;; Egroup 11: zstSTX collateral + STX+stSTX debt (80% LTV)
    ;; MASK = 2^5 + 2^64 + 2^68 = 32 + 313594649253062377472 = 313594649253062377504
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u313594649253062377504, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u8000, LTV-LIQ-PARTIAL: u8500, LTV-LIQ-FULL: u9000 }))
    ;; Egroup 12: zsBTC collateral + sBTC debt (80% LTV)
    ;; MASK = 2^3 + 2^66 = 8 + 73786976294838206464 = 73786976294838206472
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u73786976294838206472, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u8000, LTV-LIQ-PARTIAL: u8500, LTV-LIQ-FULL: u9000 }))
    ;; Egroup 13: zUSDC collateral + USDh debt (50% LTV)
    ;; MASK = 2^7 + 2^72 = 128 + 4722366482869645213696 = 4722366482869645213824
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u4722366482869645213824, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u5000, LTV-LIQ-PARTIAL: u6000, LTV-LIQ-FULL: u6500 }))
    ...
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u5902958103587056519168, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u4000, LTV-LIQ-PARTIAL: u5500, LTV-LIQ-FULL: u6000 }))
    ...
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u6290339729134957103104, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u2000, LTV-LIQ-PARTIAL: u3000, LTV-LIQ-FULL: u4000 }))
    ;; Egroup 16: zstSTXbtc collateral + STX+stSTX debt (80% LTV)
    ;; MASK = 2^11 + 2^64 + 2^68 = 2048 + 313594649253062377472 = 313594649253062379520
    (try! (contract-call? .egroup insert { BORROW-DISABLED-MASK: u0, MASK: u313594649253062379520, LIQ-CURVE-EXP: u10000, LIQ-PENALTY-MIN: u500, LIQ-PENALTY-MAX: u1000, LTV-BORROW: u8000, LTV-LIQ-PARTIAL: u8500, LTV-LIQ-FULL: u9000 }))
