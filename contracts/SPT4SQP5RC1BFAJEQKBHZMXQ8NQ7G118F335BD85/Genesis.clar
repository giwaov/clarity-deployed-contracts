...
(define-constant pot-max-participants u2)
(define-constant pot-min-amount u20000000)
(define-constant pot-name "Genesis")
(define-constant pot-type "Random Jackpot Pot")
(define-constant origin-contract-sha-hash "deccd5db26f7997a50bc1c1092d8aa4f7ae988d161987006c309cc0c9cbf9288")
(contract-call? 'SP7FSE31MWSJJFTQBEQ1TT6TF3G4J6GDKE81SWD9.stackspots register-pot {owner: tx-sender, contract: (as-contract tx-sender), cycles: pot-cycle, type: pot-type, pot-reward-token: "sbtc", min-amount: pot-min-amount, max-participants: pot-max-participants, contract-sha-hash: origin-contract-sha-hash})