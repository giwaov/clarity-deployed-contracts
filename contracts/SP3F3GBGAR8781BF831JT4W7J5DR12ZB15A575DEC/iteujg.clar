...
(use-trait ft2 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.sip-010-trait-ft-standard-v-1-1.sip-010-trait)
...
(vt1 (optional (tuple (a <ft1>) (b <ft1>) (c <ft1>))))
(sf1 (optional <sft>))
(a3 (optional uint))
...
(xt2 (optional (tuple (a <ft2>) (b <ft2>))))
