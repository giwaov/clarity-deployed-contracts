...
(use-trait ss-ft-trait 'SP2AKWJYC7BNY18W1XXKPGP0YVEK63QJG4793Z2D4.sip-010-trait-ft-standard.sip-010-trait)
...
(use-trait xyk-pool-trait-1 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-pool-trait-v-1-2.xyk-pool-trait)
(use-trait xyk-pool-trait-2 'SM1793C4R5PZ4NS4VQ4WMP7SKKYVH8JZEWSZ9HCCR.xyk-pool-trait-v-1-1.xyk-pool-trait)
...
(define-public (tativa
    (a1 (optional uint))
    (mr1 (optional uint))
    (p1 (optional principal))
    (sr1 (optional bool))
    (st1 (optional (tuple (a <ss-ft-trait>) (b <ss-ft-trait>))))
    (sp1 (optional (tuple (a <ss-pool-trait>))))
    (xt1 (optional (tuple (a <xyk-ft-trait>) (b <xyk-ft-trait>))))
    (xp1 (optional (tuple (a <xyk-pool-trait-1>))))
    (a2 (optional uint))
    (mr2 (optional uint))
    (p2 (optional principal))
    (sr2 (optional bool))
    (st2 (optional (tuple (a <ss-ft-trait>) (b <ss-ft-trait>))))
    (sp2 (optional (tuple (a <ss-pool-trait>))))
    (xt2 (optional (tuple (a <xyk-ft-trait>) (b <xyk-ft-trait>))))
    (xp2 (optional (tuple (a <xyk-pool-trait-2>))))
  )
  (let (
    (r1 
      (if (and 
...
(define-private (call-a
    ...
    (sr bool)
    (st (tuple (a <ss-ft-trait>) (b <ss-ft-trait>)))
    (sp (tuple (a <ss-pool-trait>)))
    (xt (tuple (a <xyk-ft-trait>) (b <xyk-ft-trait>)))
    (xp (tuple (a <xyk-pool-trait-1>)))
  )
  (contract-call?
