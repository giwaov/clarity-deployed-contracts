...
;; COSTS HANDLING
(define-data-var ata-costs uint u12)
...
(define-public (collect)
  (let (
    (player (unwrap! (contract-call?
      'SP1EF9EHG1JNX84RGA8Z8F8HYTSCAHWE21273RCJ4.coal-store-v0
      get-player
      tx-sender
    ) ERR_NOT_REGISTERED))
